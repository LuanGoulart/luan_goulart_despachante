...
const defaultColors = {bg1:"#4facfe", bg2:"#00f2fe", text:"#ffffff",
...
function setInputsToCurrent() {
    ...
    if (saved) {
        bg1.value = saved.bg1; bg2.value = saved.bg2; textInput.value = saved.text;
        iconWhatsColor.value = saved.iconWhats; iconInstaColor.value = saved.iconInsta;
        iconFaceColor.value = saved.iconFace; iconEmailColor.value = saved.iconEmail;
    } else {
        bg1.value = defaultColors.bg1; bg2.value = defaultColors.bg2; textInput.value = defaultColors.text;
        iconWhatsColor.value = defaultColors.iconWhats; iconInstaColor.value = defaultColors.iconInsta;
        iconFaceColor.value = defaultColors.iconFace; iconEmailColor.value = defaultColors.iconEmail;
    }
    updateAll();
}
...
function saveColors() {
    const colors = { bg1:bg1.value, bg2:bg2.value, text:textInput.value,
